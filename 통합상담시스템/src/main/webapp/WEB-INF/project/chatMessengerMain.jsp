...
<link type="text/css" rel="stylesheet"
	href="<c:url value='/css/egovframework/com/ext/msg/table.css'/>" />
...
<script>
	...
	function openPopup(roomId) {
		...
		popupPost("<c:url value='/websocketMessengePopup.do'/>", targetTitle, popOptions);
	}
...
<body>
	...
	<form name="usersForm">
		<input type="hidden" id="roomId" name="roomId" /> <input
			type="hidden" id="username" name="username" /> <input type="hidden"
			id="name" name="name" value="${loginVO.name}" /> <br />
		<div id="content">Web MESSENGER!!</div>
		<spring:message code="comExtMsg.webSocketMain.msg" />
		<br />
...
<%-- <body>
	...
	<form name="usersForm">
		<input type="hidden" id="roomId" name="roomId" /> <input
			type="hidden" id="username" name="username" /> <br />
		<div id="content">Web MESSENGER!!</div>
