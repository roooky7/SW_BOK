...
<title><spring:message code="list.insertTitle" /></title>
<body>
	...
	<h1 style="font-size: 50px;">
		<spring:message code="list.insertTitle" />
	</h1>
		...
		<table class="rwd-table">
			<tbody>
				<tr>
					...
					<td><input name="ntc_ttl" type="text" size="50"></td>
				</tr>
				<tr>
					<th><spring:message code="list.list.table.regUser" /></th>
					<td><input name="ntc_writer" type="text" size="10"
						value=${teacher.teacher_nm } readonly="readonly"></td>
				</tr>
				<tr>
					<th><spring:message code="list.list.table.content" /></th>
					<td><textarea rows="5" cols="100" name="ntc_cn"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="option"><select name="ntc_imp">
							<option value="Y"><spring:message code="list.imp" /></option>
							<option value="N"><spring:message code="list.no" /></option>
					</select></td>
				</tr>
			</tbody>
		</table>
